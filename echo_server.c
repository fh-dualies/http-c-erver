...
/**
 * Diese Funktion wird aufgerufen, wenn das Programm das *SIGINT*-Signal
 * empfängt. Es beendet den Server.
...
/**
 * Die Funktion akzeptiert den eingehenden Request und gibt eine entsprechende
 * Response zurück.
